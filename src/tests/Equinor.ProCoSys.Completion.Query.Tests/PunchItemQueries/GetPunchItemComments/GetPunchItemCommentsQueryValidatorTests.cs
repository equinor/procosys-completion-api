...
[TestClass]
public class GetPunchItemCommentsQueryValidatorTests
{
    private GetPunchItemCommentsQueryValidator _dut;
    ...
    public void Setup_OkState()
    {
        ...
        _dut = new GetPunchItemCommentsQueryValidator(_punchItemValidatorMock);
    }
