...
[TestClass]
public class GetPunchItemHistoryQueryValidatorTests
{
    private GetPunchItemHistoryQueryValidator _dut;
    ...
    public void Setup_OkState()
    {
        ...
        _dut = new GetPunchItemHistoryQueryValidator(_punchItemValidatorMock);
    }
