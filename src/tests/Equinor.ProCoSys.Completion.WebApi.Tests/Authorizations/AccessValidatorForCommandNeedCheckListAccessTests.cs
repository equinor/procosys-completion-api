...
[TestClass]
public abstract class AccessValidatorForCommandNeedCheckListAccessTests<TCommand> : AccessValidatorTestBase
    where TCommand : ICanHaveRestrictionsViaCheckList, IBaseRequest
{
