...
[TestClass]
public abstract class AccessValidatorForIIsPunchItemRelatedQueryTests<TPunchItemQuery> : AccessValidatorTestBase
    where TPunchItemQuery : IBaseRequest, IIsPunchItemRelatedQuery
{
