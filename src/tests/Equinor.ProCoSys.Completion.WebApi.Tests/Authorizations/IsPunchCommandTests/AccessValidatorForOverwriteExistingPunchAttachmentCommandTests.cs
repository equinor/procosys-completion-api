...
[TestClass]
public class AccessValidatorForOverwriteExistingPunchAttachmentCommandTests : AccessValidatorForIPunchCommandTests<OverwriteExistingPunchAttachmentCommand>
{
