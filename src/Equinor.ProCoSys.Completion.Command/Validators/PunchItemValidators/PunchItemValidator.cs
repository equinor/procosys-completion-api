...
public class PunchItemValidator : IPunchItemValidator
{
    ...
    public Task<bool> TagOwningPunchIsVoidedAsync(Guid punchItemGuid, CancellationToken cancellationToken)
    {
        // todo #103935 update code below to query tag table to check if tag for punch item is voided 
    ...
    public async Task<bool> ProjectOwningPunchIsClosedAsync(Guid punchItemGuid, CancellationToken cancellationToken)
    {
