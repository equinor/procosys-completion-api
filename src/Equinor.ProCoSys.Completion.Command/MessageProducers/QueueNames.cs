...
public static class QueueNames
{
    ...
    public const string AttachmentCompletionTransferQueue = "attachmentCompletionTransferQueue";
    public const string PunchItemCommentTransferQueue = "punchItemCommentTransferQueue";
}
