    ...
    public partial class MailTemplate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVoided = table.Column<bool>(type: "bit", nullable: false)
                        ...
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                        .Annotation("SqlServer:TemporalPeriodStartColumnName", "PeriodStart"),
                    Plant = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true)
                        .Annotation("SqlServer:IsTemporal", true)
                        .Annotation("SqlServer:TemporalHistoryTableName", "MailTemplatesHistory")
                        .Annotation("SqlServer:TemporalHistoryTableSchema", null)
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MailTemplates_Persons_ModifiedById",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "MailTemplates",
                columns: new[] { "Code", "Plant" },
                unique: true,
                filter: "[Plant] IS NOT NULL")
                .Annotation("SqlServer:Include", new[] { "Subject", "Body", "IsVoided" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MailTemplates_ModifiedById",
                table: "MailTemplates",
                column: "ModifiedById");
        }
