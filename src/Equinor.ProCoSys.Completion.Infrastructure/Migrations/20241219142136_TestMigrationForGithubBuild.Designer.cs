...
namespace Equinor.ProCoSys.Completion.Infrastructure.Migrations
{
    ...
    [Migration("20241219142136_TestMigrationForGithubBuild")]
    partial class TestMigrationForGithubBuild
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Equinor.ProCoSys.Completion.Domain.AggregateModels.AttachmentAggregate.Attachment", b =>
                {
                    ...
                    b.Property<string>("ProCoSys4LastUpdatedByUser")
                        .HasMaxLength(120)
            ...
            modelBuilder.Entity("Equinor.ProCoSys.Completion.Domain.AggregateModels.HistoryAggregate.HistoryItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("EventByFullName")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");

                    b.Property<Guid>("EventByOid")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable(tb => tb.IsTemporal(ttb =>
                            {
                                ttb.UseHistoryTable("HistoryHistory");
                                ttb
                                    .HasPeriodStart("PeriodStart")
                                    .HasColumnName("PeriodStart");
                                ttb
            ...
            modelBuilder.Entity("Equinor.ProCoSys.Completion.Domain.AggregateModels.HistoryAggregate.Property", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<Guid?>("OidValue")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("OldOidValue")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Equinor.ProCoSys.Completion.Domain.AggregateModels.LibraryAggregate.Classification", b =>
                {
                    ...
                    b.ToTable(tb => tb.IsTemporal(ttb =>
                            {
                                ttb.UseHistoryTable("ClassificationsHistory");
                                ttb
                                    .HasPeriodStart("PeriodStart")
                                    .HasColumnName("PeriodStart");
                                ttb
            ...
            modelBuilder.Entity("Equinor.ProCoSys.Completion.Infrastructure.CompletionContext+NewTable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Equinor.ProCoSys.Completion.Domain.AggregateModels.HistoryAggregate.Property", b =>
                {
                    b.HasOne("Equinor.ProCoSys.Completion.Domain.AggregateModels.HistoryAggregate.HistoryItem", null)
                        .WithMany("Properties")
            ...
            modelBuilder.Entity("Equinor.ProCoSys.Completion.Domain.AggregateModels.LibraryAggregate.Classification", b =>
                {
                    b.HasOne("Equinor.ProCoSys.Completion.Domain.AggregateModels.LibraryAggregate.LibraryItem", null)
