...
namespace Equinor.ProCoSys.Completion.Infrastructure.Migrations
{
    ...
    [Migration("20230621095300_RenamePunchColumns")]
    partial class RenamePunchColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Equinor.ProCoSys.Completion.Domain.AggregateModels.PunchAggregate.Punch", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Guid"), new[] { "ItemNo", "Description", "ProjectId", "CreatedById", "CreatedAtUtc", "ModifiedById", "ModifiedAtUtc", "IsVoided", "RowVersion" });
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ProjectId"), new[] { "ItemNo", "IsVoided", "RowVersion" });
