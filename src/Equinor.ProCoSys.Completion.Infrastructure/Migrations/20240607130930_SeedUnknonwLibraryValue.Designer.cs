...
namespace Equinor.ProCoSys.Completion.Infrastructure.Migrations
{
    ...
    [Migration("20240607130930_SeedUnknonwLibraryValue")]
    partial class SeedUnknonwLibraryValue
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Equinor.ProCoSys.Completion.Domain.AggregateModels.LibraryAggregate.LibraryItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Guid = new Guid("0e8be842-6821-4733-b1b1-801574b4fe2b"),
                            IsVoided = true,
                            Plant = "N/A",
                            ProCoSys4LastUpdated = new DateTime(2024, 6, 7, 15, 9, 29, 737, DateTimeKind.Local).AddTicks(7292),
                            SyncTimestamp = new DateTime(2024, 6, 7, 15, 9, 29, 737, DateTimeKind.Local).AddTicks(7360),
                            Type = "COMPLETION_ORGANIZATION"
                        });
                });
