    ...
    public partial class CommentMentions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CommentId = table.Column<int>(type: "int", nullable: false)
                        ...
                        .Annotation("SqlServer:TemporalHistoryTableName", "CommentPersonHistory")
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentPerson", x => new { x.CommentId, x.MentionsId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_CommentPerson_Persons_MentionsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentPerson_MentionsId",
                table: "CommentPerson",
                column: "MentionsId");
        }
