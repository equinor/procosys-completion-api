...
public class GetPunchItemAttachmentsQueryValidator : AbstractValidator<GetPunchItemAttachmentsQuery>
{
    public GetPunchItemAttachmentsQueryValidator(IPunchItemValidator punchItemValidator)
    {
