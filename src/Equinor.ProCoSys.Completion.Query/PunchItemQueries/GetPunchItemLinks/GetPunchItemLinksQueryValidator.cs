...
public class GetPunchItemLinksQueryValidator : AbstractValidator<GetPunchItemLinksQuery>
{
    public GetPunchItemLinksQueryValidator(IPunchItemValidator punchItemValidator)
    {
