...
public class GetPunchItemCommentsQueryValidator : AbstractValidator<GetPunchItemCommentsQuery>
{
    public GetPunchItemCommentsQueryValidator(IPunchItemValidator punchItemValidator)
    {
