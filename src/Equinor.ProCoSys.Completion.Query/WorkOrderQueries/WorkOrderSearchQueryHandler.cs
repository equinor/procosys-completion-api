...
public class WorkOrderSearchQueryHandler(IReadOnlyContext context)
    : IRequestHandler<WorkOrderSearchQuery, IEnumerable<WorkOrderDto>>
{
    public async Task<IEnumerable<WorkOrderDto>> Handle(WorkOrderSearchQuery request, CancellationToken cancellationToken)
    {
